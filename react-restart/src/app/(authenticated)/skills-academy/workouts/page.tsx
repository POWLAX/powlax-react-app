...
import { Clock, Trophy, Target, Zap, Shield, Users, Plus, GraduationCap } from 'lucide-react'
    ...
    <div className="container mx-auto p-4 max-w-7xl">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-3xl font-bold">Skills Academy Workouts</h1>
          <div className="flex gap-2">
            <Button 
              onClick={() => router.push('/skills-academy/workout-builder')}
              variant="outline"
            ...
            <Button 
              onClick={() => router.push('/skills-academy/workout-builder/advanced')}
