...
import BadgeCollectionSpring from './BadgeCollectionSpring'
import { PointExplosionDemo } from './PointExplosionCanvas'
import { SkillTreeDemo } from './SkillTreeSVG'
import { ComboSystemDemo } from './ComboSystemFire'
import { PowerUpWebGLDemo } from './PowerUpWebGL'
import { TeamChallengeDemo } from './TeamChallengeRacing'
...
const animationDemos: AnimationDemo[] = [
  {
    ...
    component: () => (
      <div style={{ 
        ...
        <button
          onClick={() => {
            const container = document.getElementById('badge-unlock-demo')
            if (container) {
              container.innerHTML = ''
              const badge = document.createElement('div')
              badge.innerHTML = `<div id="badge-component"></div>`
        ...
        <>
          ...
          <div className="technical-details">
            ...
            <div className="tech-grid">
              ...
              <div className="tech-item">
                <h4>Performance</h4>
                <p>Progressive enhancement based on device capabilities</p>
                <div className="tech-examples">Quality settings, Frame limiting</div>
              </div>
            </div>
          </div>
        </>
