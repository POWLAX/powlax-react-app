...
export default function ManagementPage() {
  ...
  // For development: Create a test user if no auth user exists (matching dashboard pattern)
  ...
  const roleManagementContent = (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <Card className="bg-white rounded-lg border border-gray-200 shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm text-gray-900">Administrators</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white rounded-lg border border-gray-200 shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm text-gray-900">Directors</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white rounded-lg border border-gray-200 shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm text-gray-900">Coaches</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white rounded-lg border border-gray-200 shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm text-gray-900">Players</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white rounded-lg border border-gray-200 shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm text-gray-900">Parents</CardTitle>
          </CardHeader>
          <CardContent>
  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-7xl">
      ...
      {/* Management Tabs with Role Management Content */}
      <ManagementTabs defaultTab="roles">
