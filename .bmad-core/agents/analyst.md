...
agent-awareness:
  ...
  handoff-protocol:
    detection: |
      When a task involves expertise outside my core analysis focus:
    ...
    context-preservation: |
      ...
      - Specific questions or data needs
      - Relevant documentation or findings
      - Any business requirements identified
```
